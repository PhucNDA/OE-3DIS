...
def resolve_overlapping_masks(pred_masks, pred_scores, score_thresh=0.5, device="cuda"):
...
class PointCloudToImageMapper(object):
    def __init__(self, image_dim,
            visibility_threshold=0.25, cut_bound=0, intrinsics=None, device='cpu', use_torch=False):
