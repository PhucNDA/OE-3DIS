...
# From https://github.com/ScanNet/ScanNet/blob/master/BenchmarkScripts/3d_evaluation/evaluate_semantic_instance.py
...
from loader3d.eval_utils import util
from loader3d.eval_utils import util_3d
import pdb
